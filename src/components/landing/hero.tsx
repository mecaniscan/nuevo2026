        ...
        <section className="relative w-full h-[75vh] md:h-[90vh] overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-foreground px-4">
                 <div className="max-w-5xl p-8 rounded-2xl backdrop-blur-[2px]">
                    <h1 className="text-5xl font-extrabold tracking-tight bg-gradient-to-r from-primary via-cyan-400 to-blue-500 text-transparent bg-clip-text sm:text-6xl md:text-7xl lg:text-8xl font-headline shadow-text drop-shadow-2xl pb-4">
                        MecaniScan Pro
                    </h1>
